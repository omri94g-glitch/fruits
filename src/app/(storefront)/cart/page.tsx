...
export default function CartPage() {
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-14">
      <h1 className="font-serif text-3xl text-green-700 mb-8 text-center">עגלת קניות</h1>

      <div className="flex flex-col gap-4">
        {items.map((item) => (
          <div
            key={`${item.productId}-${item.variantId}`}
            className="flex items-center gap-4 border border-line rounded-2xl p-4"
          >
            ...
            <span className="w-20 text-center text-sm">{item.price * item.quantity} ₪</span>
      ...
      <div className="flex items-center justify-between mt-8 border-t border-line pt-6">
        <span className="text-ink/60">סה&quot;כ</span>
